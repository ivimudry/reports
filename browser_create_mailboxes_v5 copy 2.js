...
Далі в Customer.io ці дані підставляються в запит для CM.com.
{
   "messages": {
       "msg": [                          // масив повідомлень (можна кілька, але ми шлемо 1)
           {
...
Потім CM.com обробляє цей запит і відправляє SMS на вказаний номер телефону з текстом, який був у тригері. У Customer.io можна налаштувати логування або обробку відповіді від CM.com для відстеження статусу доставки SMS.