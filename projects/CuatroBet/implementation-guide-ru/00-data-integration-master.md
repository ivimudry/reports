...
| ------------- | --------- | ------------------- | -------- | ---------------------- | ---- | -------- | -------- |
| `WBL-S-D1`  | 1-й       | 120% (150% если >69K) | 50     | Gates of Olympus       | —   | 25×     | 7 дней   |
...
| `KYC-DOCS-REWARD-EARLY` | Документы подтверждены до порога 103K            | 4,600 ARS | None     |            |
| `KYC-DOCS-REWARD-HARD`  | Документы подтверждены на пороге/после 103K      | 9,000 ARS | None     |            |
