...
Average deposit: roughly 1,800 ARS (6 USD)
Deposit frequency: 2.5 per user
Bonus cost: 10.5% of GGR in April, 9.5% in March
KYC soft threshold: 22,500 ARS (75 USD) before document verification required
...
App Push: dormant. Zero sends across the period observed. Recommended to be activated.
...
Part III: Cross-cutting redesigns. Changes that span multiple lifecycles or touch product surfaces outside the lifecycle map: channel rebalancing, the bonuses landing page, the bonus shop catalogue, the referral program, smart segmentation setup, and App Push activation.
...
Offer: 1,000 ARS no-deposit bonus on any deposit action within 6 hours, 15x wagering
Exit: continues to T+24h decision
...
Offer: 75% match up to 3,000 ARS plus 20 FS on Joker’s Jewels, wagering 25x, expires in 48 hours
...
Offer: 500 ARS no-deposit free bet on Aviator, wagering 1x
...
T+48 h SMS: 500 ARS free bet on Aviator (same as Slots path)

## Cost model

Expected cost per player entering the Day 1 Layer:
Average deposit is 1,800 ARS, so the layer costs roughly 22% of the first deposit. This is fully funded from the existing bonus budget by reducing welcome bonus wagering (which lifts the bonus cost metric anyway) and stopping the NC Feed blast over-sending.
...
App Push must be activated before launch. The layer can run without App Push but loses roughly 30% of its effective touches in the T+6h decision branch.
...
Identify players who have deposited 150,000 ARS cumulatively (roughly 500 USD) and coach them toward the VIP I threshold (roughly 300,000 ARS or 1,000 USD cumulative) within 30 days. The current VIP base is 15 players. A functioning Pre-VIP layer grows it to 30 to 45 in the first quarter by capturing players who are already on the path but are not being actively managed.

## Entry trigger

Cumulative lifetime deposits reach 150,000 ARS AND the player has been active in the last 14 days.
...
Action: enable 15% weekly cashback for 30 days (wager-free, applied every Monday on the previous week’s net losses, capped at 30,000 ARS)
...
Offer: 60% match up to 10,000 ARS plus 30 FS on a premium PP title, wagering 20x, validity 72 hours

### Day 10: Soft coaching push

Channel: App Push plus SMS
...
Offer: 100% match up to 20,000 ARS plus 50 FS plus extended cashback, wagering 15x, validity 72 hours
...
The 150,000 ARS entry threshold is calibrated against the brand’s own tier economics (Premium unlock at 15,000 ARS, Maestro at 35,000 ARS, VIP I starts around 300,000 ARS cumulative). Review quarterly.
...
Move KYC completion from 20% to 35 to 40% by converting verification from a compliance chore into a rewarded journey. The current state: half of verifiers complete immediately, half only when they try to withdraw, and most never complete at all. Verification is gated on the 22,500 ARS (75 USD) cumulative deposit threshold for documents, while email and phone verification are technically optional but should be driven earlier.

## Three phases

Phase 1: Email verification (day 0, triggered by registration)
Phase 2: Phone verification (day 0, immediately after email)
Phase 3: Document verification (triggered when cumulative deposits reach 15,000 ARS)
...
Content (ES): “Verificá tu email y recibí 500 ARS de regalo al instante”
Offer: 500 ARS bonus on email verification, no wagering on the bonus, can be used directly
...
Content (ES): “Verificá tu teléfono y recibí 500 ARS más. Total: 1,000 ARS al instante”
...
Cumulative deposits reach 15,000 ARS (roughly 50 USD) AND not yet document-verified.
Rationale: do not wait for the 22,500 ARS hard threshold. Start the document nudge 30% earlier so there is runway to complete before the withdrawal block kicks in.

### Day 1 at 15,000 ARS threshold

Channel: in-app banner plus Email
Content (ES): “Completá tu verificación ahora y desbloqueá retiros más rápidos plus un bono de 1,000 ARS”
...
### On cumulative deposits reaching 22,500 ARS (the hard threshold)

Channel: in-session popup plus Email plus SMS
Content (ES): “Verificación obligatoria para retiros. Completá ahora y recibí 2,000 ARS de bono final”
Offer: 2,000 ARS bonus (doubled from the Day 1 offer) as final reward for completing

### On verification acceptance

Credit the 2,000 ARS bonus
...
Not all players will reach Phase 3. The blended cost across the whole registered base is lower, probably 400 to 500 ARS per registered player.
...
D1 Welcome is the hook. Strongest headline bonus (120% standard, 150% for deposits above 15,000 ARS), 25x wagering, branded to the vertical.
...
D9 and D10 are the Pre-VIP gate. High match with low wagering, Lucky Wheel entries, and at D10 automatic enrollment in the Pre-VIP Lifecycle if cumulative deposits reach 150,000 ARS.

## Slots ladder (the main audience, 99% of players)

Free spins are rotated across the actual top-played slots, not Sweet Bonanza.
Safeguards for Slots: wagering contribution slots 100% / live 10% / table 5%, max bet during wagering 1,500 ARS per spin, max bonus balance 30,000 ARS at any time, one claim per deposit.
...
Segment: ad-hoc triggers set by the CRM manager (e.g., player mentioned a specific game in support, player 5,000 ARS from a tier threshold).
...
Mechanic: players earn loot box tokens through gameplay. 1 token per 5,000 ARS wagered on slots, 1 token per 10,000 ARS wagered on live. Opened manually from the dashboard.
...
Rewards: single sticker 25 CC, row of 5 is 200 ARS + 10 FS, all 30 is 10,000 ARS + premium Lucky Wheel + VIP I preview.
...
Mechanic: tiered wheel spins earned by wagering. Silver (1 per 2,000 ARS wagered), Gold (1 per 10,000 ARS), Platinum (1 per 50,000 ARS).
...
Mechanic: player opts in and commits to a fixed amount (1,500 / 3,000 / 5,000 / 10,000 ARS), deposits that exact amount 4 times in 7 days. Resets if a deposit does not match.
...
Active × 7 days Comm 1 specifies a base offer of “30% match up to 2,000 ARS + 20 FS on Jackpot Joker, 15x wagering, 48h validity”. Applied by tier at send time:
Micro player: 50 CC gift only, no match bonus. Reactivation cost near zero for a player unlikely to return.
Low player: 30% match up to 2,000 ARS + 20 FS, 15x, 48h. Base offer as written in the cell.
Mid player: 45% match up to 3,000 ARS + 30 FS, 15x, 48h.
High player: 60% match up to 4,000 ARS + 40 FS, 15x, 48h, sent from the CRM owner’s named email rather than the brand email.
Pre-VIP and above: 75% match up to 5,000 ARS + 50 FS + 100 CC, 12x, 72h, delivered by the CRM owner via WhatsApp with a personal message.
...
The current channel mix is out of balance. NC Feed and NC Pop-Up are fatigued from over-sending, SMS is the best performer and under-used, Email is healthy but declining, App Push is dormant.
...
Inconsistent Free Bet pricing: 8,000 ARS free bet at 350 CC, 3,000 ARS free bet at 150 CC. Different CC-to-ARS ratios for similar products.
...
KYC required for referrer to receive rewards above 1,000 ARS cash
...
Launch bonus: first 100 successful referrals (STD) get an extra 1,000 ARS cash on top of standard reward
Leaderboard: top 10 referrers per month get an additional 10,000 ARS cash prize
...
Pre-VIP (lifetime deposits 150,000 to 300,000 ARS)
...
The roadmap is sequenced to deliver quick wins first (channel cooling, bonus ladder calibration) while longer-lead items (App Push, Predictive Churn) are built in parallel.
...
Week 1: request App Push technical setup
Week 2: recalibrate the Welcome Bonus Ladder (Slots, Live, Sport) with new wagering requirements
Week 2: launch the Day 1 Retention Layer (phase 1 without App Push)
...
Week 4: activate App Push channel (opt-in flow, Day 1 Layer integration)
...
App Push opt-in rate: target 40%+
...
☐ App Push channel configured and opt-in flow live
...
Economics - Average deposit: 1,800 ARS (~6 USD) - Deposit frequency: 2.5 per user - Bonus cost: 10.5% of GGR - ADPU matures ~10x from month 0 ($15) to month 5 ($150)
Argentina context - Working rate: ~300 ARS per USD - KYC threshold: 22,500 ARS (75 USD) - Payment methods: Mercado Pago, Naranja Betterbro, bank transfer - Product mix: 99.9% casino
...
| 1,000 ARS urgency bonus (T+6h Comm B) | 30% reach rate | roughly 100 |
| 75% reload email (T+24h) | 20% claim | roughly 150 |
| 500 ARS Aviator free bet (T+48h) | 10% claim | roughly 25 |
| Average cost per FTD player |  | roughly 395 ARS |
...
| 5 | Email | 60% match up to 10,000 ARS + 30 FS (20x) | First coaching reload |
| 10 | Push + SMS | Soft coaching message, no offer | Awareness |
| 15 | Email + SMS | 100% match up to 20,000 ARS + 50 FS (15x) | Strong second chance |
...
| --- | --- | --- | --- |
| Phase 1 email | 500 ARS | roughly 60% | 300 |
| Phase 2 phone | 500 ARS | roughly 50% | 250 |
| Phase 3 docs (at 15k) | 1,000 ARS | roughly 20% | 200 |
| Phase 3 docs (at 22.5k) | 2,000 ARS | roughly 15% | 300 |
| Total average |  |  | roughly 1,050 ARS per player |
...
| 100 CC recovery reward | roughly 40 ARS | 20% of failures |
| Average cost per failure | roughly 8 ARS |  |


<!-- TABLE 5 -->
| Deposit | Match | Max cap | Free spins | Wagering | Validity | Extra |
| --- | --- | --- | --- | --- | --- | --- |
| D1 Welcome | 120% | 10,000 ARS | 50 FS on Gates of Olympus | 25x | 7 days | Max bet 1,500 ARS |
| D2 | 75% | 5,000 ARS | 30 FS on Joker’s Jewels | 20x | 48 h |  |
| D3 | 60% | 5,000 ARS | 30 FS on Jackpot Joker | 20x | 48 h |  |
| D4 | 50% | 6,000 ARS | 40 FS on 4 Supercharged Clovers | 18x | 48 h |  |
| D5 | 50% | 7,500 ARS | 50 FS rotating PP top | 18x | 48 h | 50 CC gift |
| D6 | 50% | 8,000 ARS | 60 FS | 15x | 48 h | Weekly Lucky Wheel entry |
| D7 | 60% | 10,000 ARS | 70 FS | 15x | 48 h | 100 CC gift |
| D8 | 60% | 10,000 ARS | 80 FS | 15x | 72 h | 200 CC gift |
| D9 | 70% | 15,000 ARS | 90 FS | 15x | 72 h | Lucky Wheel premium |
| D10 | 100% | 20,000 ARS | 100 FS | 12x | 72 h | 500 CC + Pre-VIP gate |


<!-- TABLE 6 -->
| Deposit | Match | Max cap | Bonus Cash | Wagering | Validity | Extra |
| --- | --- | --- | --- | --- | --- | --- |
| D1 Welcome | 120% | 10,000 ARS | 5,000 ARS | 30x | 7 days | Bet cap 5,000/hand |
| D2 | 75% | 7,000 ARS | 3,000 ARS | 25x | 48 h |  |
| D3 | 60% | 6,000 ARS | 3,000 ARS | 25x | 48 h |  |
| D4 | 50% | 7,500 ARS | 4,000 ARS | 20x | 48 h |  |
| D5 | 50% | 8,000 ARS | 5,000 ARS | 20x | 48 h | 100 CC |
| D6 | 50% | 10,000 ARS | 5,000 ARS | 20x | 48 h |  |
| D7 | 60% | 12,000 ARS | 6,000 ARS | 18x | 48 h | 200 CC |
| D8 | 60% | 15,000 ARS | 8,000 ARS | 18x | 72 h |  |
| D9 | 75% | 20,000 ARS | 10,000 ARS | 15x | 72 h | Lucky Wheel |
| D10 | 100% | 25,000 ARS | 15,000 ARS | 12x | 72 h | 500 CC + Pre-VIP gate |


<!-- TABLE 7 -->
| Deposit | Match | Max cap | Free Bet | Wagering | Validity | Extra |
| --- | --- | --- | --- | --- | --- | --- |
| D1 Welcome | 120% | 8,000 ARS | 3,000 ARS | 5x | 7 days | Min odds 1.80 |
| D2 | 75% | 5,000 ARS | 2,000 ARS | 5x | 48 h |  |
| D3 | 60% | 4,000 ARS | 2,000 ARS | 5x | 48 h |  |
| D4 | 50% | 5,000 ARS | 2,500 ARS | 5x | 48 h |  |
| D5 | 50% | 6,000 ARS | 3,000 ARS | 5x | 48 h | 50 CC |
| D6 | 50% | 7,000 ARS | 3,500 ARS | 5x | 48 h |  |
| D7 | 60% | 8,000 ARS | 4,000 ARS | 5x | 48 h | 100 CC |
| D8 | 60% | 10,000 ARS | 5,000 ARS | 5x | 72 h |  |
| D9 | 70% | 12,000 ARS | 6,000 ARS | 5x | 72 h | Lucky Wheel |
| D10 | 100% | 15,000 ARS | 8,000 ARS | 5x | 72 h | 500 CC + Pre-VIP gate |


<!-- TABLE 8 -->
| Comm | Timing | Channel | Content and offer |
| --- | --- | --- | --- |
| Comm 1 | T+30 min | In-app popup + App Push | ES: “Listo para empezar? Reclamá tu 120% + 50 FS ahora”. CTA: deep-link to cashier with welcome bonus preselected. |
...
| Comm 4 | T+72 h | Email + App Push | Subject ES: “Última oportunidad: 150% en tu primer depósito”. Enhanced 150% offer, 48 h validity, 25x wagering. |


<!-- TABLE 9 -->
| Comm | Timing | Channel | Content and offer |
| --- | --- | --- | --- |
| Comm 1 | T+5 min | In-session popup (if on site) or App Push | ES: “Hubo un problema procesando tu depósito. Probá con otro método ahora”. CTA: 3 buttons for Mercado Pago, Naranja Betterbro, bank transfer. |
| Comm 2 | T+30 min | SMS | ES 160 chars: “CuatroBet: Probá de nuevo: [link]. Sumamos 200 ARS de regalo por la molestia”. 200 ARS no-deposit goodwill credit, no wagering. |
...
| Comm 4 | T+24 h | App Push + NC Feed | ES: “Tu bono 120% + 50 FS te sigue esperando. Probá con Transferencia bancaria” |
...
| Comm 2 | T+1 h | Email (personal, “María, equipo CuatroBet”) | Subject ES: “Podemos ayudarte a depositar”. Offer callback or WhatsApp support, 3 alternate methods, 500 ARS goodwill credit. |
| Comm 3 | T+6 h | SMS | ES: “Responde RETRY y te llamamos, o probá acá: [link]”. 500 ARS credit still valid. |
...
| Comm 4 | T+24 h | App Push + SMS | ES SMS: “CuatroBet: Tu bono sigue vigente. Probá con Transferencia bancaria” |
...
| Comm | Timing | Channel | Content and offer |
| --- | --- | --- | --- |
| Comm 1 | T+1 h | In-session popup + App Push | ES: “Tu bono de bienvenida 120% + 50 FS está listo. Reclamalo ahora”. CTA auto-applies bonus. |
...
| Comm | Timing | Channel | Content and offer |
| --- | --- | --- | --- |
| Comm 1 | T+24 h | Email | Subject ES: “Bienvenido a CuatroBet. Explorá nuestra biblioteca de juegos”. Top games showcase, 500 ARS no-deposit Aviator free bet at the end (1x wagering). |
| Comm 2 | T+7 days | Email | Subject ES: “Novedades en CuatroBet esta semana”. New games, tournaments, soft reminder of the 500 ARS free bet. |
| Comm 3a | T+14 days, track A | App Push + NC Feed | ES: “Girá la Lucky Wheel. Entrada gratis esta semana”. Free Lucky Wheel spin, prizes 50 to 2,000 ARS. |
...
| Comm 4 | T+30 days | Email + SMS | Subject ES: “Recarga única: 50% sin letra chica”. 50% match up to 2,000 ARS, 15x wagering, 72 h expiry. |


<!-- TABLE 15 -->
| Comm | Timing | Channel | Content |
| --- | --- | --- | --- |
| Comm 1 | T+30 min | App Push or Web Push | ES: “Gracias por visitarnos. Tu bono 120% + 50 FS te está esperando”. Deep-link to homepage with welcome modal. |
...
| Comm 2 | T+2 h | App Push | ES: “Tu bono sigue disponible. Mercado Pago acepta desde 500 ARS” |
...
| Comm 3 | T+24 h | App Push | ES: “Tu bono 120% + 50 FS te espera. Depositá desde 500 ARS” |
...
| Comm 2 | Day of | Email + App Push | Subject ES: “Feliz aniversario! Tu regalo te espera”. 100% reload up to 10,000 ARS + 100 FS on favorite game, 15x wagering, 7 days. |
...
| Comm 2 | Day of | Email + App Push + SMS | Subject ES: “Feliz cumpleaños!”. 5,000 ARS wager-free cash + 50 FS on Gates of Olympus. |
| Comm 3 | Day after | Email | Subject ES: “Gracias por pasar tu cumpleaños con nosotros”. Warm message, 7-day validity reminder. |
| Comm 4 | 7 days after | App Push | ES: “Tu regalo de cumpleaños vence hoy. Reclamalo: [link]” |
...
| Comm 2 | Day 3 | App Push | 50% match up to 5,000 ARS + 30 FS on themed slots, 20x wagering. |
...
| --- | --- | --- |
| Common | 60% | 100 ARS cash or 20 CC or 5 FS |
| Uncommon | 25% | 500 ARS cash or 50 CC or 15 FS |
| Rare | 10% | 1,500 ARS cash or 150 CC or 30 FS premium |
| Epic | 4% | 5,000 ARS cash or 500 CC or Lucky Wheel spin |
| Legendary | 1% | 15,000 ARS cash or VIP I preview |
...
| Tier | Reward range |
| --- | --- |
| Silver | 50 to 500 ARS cash, or 5 to 20 FS, or 10 to 50 CC |
| Gold | 200 to 2,000 ARS cash, or 20 to 80 FS, or 50 to 200 CC |
| Platinum | 1,000 to 15,000 ARS cash, or Lucky Wheel entry, or VIP I preview |


<!-- TABLE 24 -->
| Deposit size × 4 | Reward |
| --- | --- |
| 4 × 1,000 ARS | 500 ARS cashback + 20 FS |
| 4 × 2,500 ARS | 1,500 ARS cashback + 40 FS + 100 CC |
| 4 × 5,000 ARS | 4,000 ARS cashback + 80 FS + 250 CC |
| 4 × 10,000 ARS | 10,000 ARS cashback + 150 FS + 500 CC + Lucky Wheel |
...
| Day 3 consecutive | 100 CC + 50 FS + 2,000 ARS bonus cash |


<!-- TABLE 26 -->
| Committed amount × 4 | Reward |
| --- | --- |
| 4 × 1,500 ARS | 1,500 ARS cashback + 30 FS |
| 4 × 3,000 ARS | 4,000 ARS cashback + 60 FS + 150 CC |
| 4 × 5,000 ARS | 8,000 ARS cashback + 100 FS + 300 CC + Lucky Wheel |
| 4 × 10,000 ARS | 20,000 ARS cashback + 200 FS + 750 CC + Pre-VIP preview |


<!-- TABLE 27 -->
| Tier | Total turnover across 4 slots | Reward |
| --- | --- | --- |
| Light | 20,000 ARS | 500 ARS cashback + 20 FS |
| Medium | 50,000 ARS | 2,000 ARS cashback + 50 FS + 100 CC |
| Heavy | 150,000 ARS | 8,000 ARS cashback + 100 FS + 300 CC + Lucky Wheel |


<!-- TABLE 28 -->
| Tier | Criteria | Offer |
| --- | --- | --- |
| Low | 1 deposit in last 7 days | 40% up to 3,000 ARS + 20 FS, 15x |
| Mid | 2 to 3 deposits | 50% up to 5,000 ARS + 30 FS + 50 CC, 15x |
| High | 4+ deposits | 60% up to 8,000 ARS + 50 FS + 100 CC, 12x |
| Pre-VIP/VIP | Status | 75% up to 15,000 ARS + 75 FS + 200 CC + cashback boost, 10x |
...
| 2 | 20 CC + 5 FS |
| 3 | 30 CC + 10 FS |
| 4 | 50 CC + 20 FS + 100 ARS |
| 5 | 75 CC + 25 FS + 250 ARS |
| 6 | 100 CC + 40 FS + 500 ARS |
| 7 (weekly reset) | 200 CC + 60 FS + 1,500 ARS + Lucky Wheel |


<!-- TABLE 30 -->
| Holiday | Date | Headline offer |
| --- | --- | --- |
| New Year | Jan 1 | 150% up to 15,000 ARS + 150 FS |
...
| Comm 2 | Bi-weekly Thursday | App Push | “Tu bonus shop tiene items nuevos” with personalized top 3 SKUs. Drives shop redemption. |
...
| Comm 4 | Monthly exclusive | Email + App Push | “Evento exclusivo para [tier]”. Invitation to a loyalty-only tournament or giveaway. |
...
| Comm 2 | Day 10 | App Push + NC Feed | ES: “No pierdas tu progreso. Completá una misión hoy y ganá 50 CC extra”. 50 CC bonus on next mission. |
| Comm 3 | Day 14 | Email + SMS | 40% reload up to 3,000 ARS + 100 CC + 20 FS, 15x wagering, 72 h. |
...
| --- | --- | --- | --- |
| Micro | 0 to 5,000 ARS | 0.5x (or swap for CC-only gift) | Low return probability, protect budget |
| Low | 5,000 to 30,000 ARS | 1.0x (base) | Standard reactivation offer |
| Mid | 30,000 to 150,000 ARS | 1.5x | Stronger pull, same channel mix |
| High | 150,000 to 600,000 ARS | 2.0x | Personal email from CRM owner name (not brand) |
| Pre-VIP and above | above 600,000 ARS or Pre-VIP flag | 2.5x | WhatsApp outreach plus manager escalation |


<!-- TABLE 34 -->
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | Day 7 | SMS | ES: “Te extrañamos. 30% en tu próximo depósito + 20 FS en Jackpot Joker: [link]”. 30% match up to 2,000 ARS + 20 FS, 15x, 48 h. |
| 2 | Day 8 | Email | Subject: “Novedades en CuatroBet esta semana”. Top games, tournaments, bonus reminder at bottom. |
| 3 | Day 9 | App Push | ES: “100 CC de regalo si volvés a jugar hoy”. 100 CC no-deposit, no wagering. |
| 4 | Day 10 | NC Feed + App Push | Lucky Wheel free spin invitation, no deposit. |


<!-- TABLE 35 -->
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 14 | Email (personal tone) | Subject: “Nota personal de CuatroBet”. 50% up to 5,000 ARS + 30 FS on favorite game, 15x, 72 h. |
| 2 | 15 | SMS | ES: “Tu bono 50% + 30 FS te espera. Vence mañana: [link]” |
| 3 | 16 | App Push | Gamification entry (Lucky Wheel or 4 Deposit Quest pitch). |
| 4 | 18 | Email | Subject: “Tu bono 50% terminó pero tenemos algo nuevo”. Fresh 60% up to 6,000 ARS + 40 FS + 100 CC, 72 h. |


<!-- TABLE 36 -->
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 21 | Email (from CRM owner name) | Subject: “Construimos algo que te va a encantar”. Personal tone, curated game recommendation. 75% up to 10,000 ARS + 50 FS + 250 CC, 12x, 72 h. For Pre-VIP+: 100% match + cashback boost. |
| 2 | 25 | SMS + Email | ES: “CuatroBet: Tu 75% + 50 FS sigue disponible hasta [fecha]: [link]” |
| 3 | 28 | WhatsApp (Pre-VIP+) or App Push (others) | Personal outreach for high-value, automated push for others. |
| 4 | 30 | Email | Subject: “Último llamado”. Escalated 100% up to 15,000 ARS + 75 FS + 500 CC, 15x, 48 h. |


<!-- TABLE 37 -->
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 7 | Email | Subject: “Tus juegos favoritos te esperan”. 25% up to 1,500 ARS + 15 FS, 15x, 72 h. |
| 2 | 8 | App Push | 50 CC gift, no deposit. |
...
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 14 | Email | 35% up to 2,500 ARS + 20 FS, 15x, 72 h. |
| 2 | 15 | App Push | Bonus reminder. |
...
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 21 | Email | 50% up to 4,000 ARS + 25 FS + 100 CC, 15x, 72 h. |
| 2 | 25 | SMS | Reminder. |
| 3 | 28 | App Push | Reminder. |
| 4 | 30 | Email | Final 60% up to 5,000 ARS + 30 FS, 48 h. |


<!-- TABLE 40 -->
| Comm | Timing | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | T+0 after verification | Email | Subject: “Bienvenido! Tu cuenta está totalmente verificada”. Celebrate verification, deposit guide, enhanced welcome 150% up to 12,000 ARS + 75 FS, 20x. |
| 2 | T+24 h | SMS | ES: “CuatroBet: Tu cuenta está verificada. 150% + 75 FS te esperan: [link]” |
| 3 | T+72 h | Email + App Push | Address friction (payment methods walkthrough, deposit amount flexibility, trust signals). |
...
| App Push | 0 | 3,000 to 5,000 | ACTIVATE, Day 1 Layer, Post-FTD, Pre-VIP |
...
| Day 1 Retention (0 to 72h) | In-session popup, SMS, App Push |
| Post-FTD to STD | Email, SMS, App Push, sparing NC Feed |
| Regular player | Email, App Push, NC Feed (properly segmented) |
...
| 80 | 1,000 ARS site credit (10x wagering) |
| 100 | 25 FS on 4 Supercharged Clovers |
| 120 | 2,000 ARS site credit (10x wagering) |
| 150 | 30% match up to 3,000 ARS on any deposit |


<!-- TABLE 46 -->
| CC | Reward |
| --- | --- |
| 200 | 50% match up to 5,000 ARS + 20 FS on top game |
| 250 | 10 Free Flights on Aviator + 100 CC bonus |
| 300 | 3,000 ARS free bet + 500 ARS cashback |
| 350 | 75% match up to 8,000 ARS + 30 FS |
| 400 | 100% match up to 10,000 ARS (15x wagering) |


<!-- TABLE 47 -->
| CC | Reward |
| --- | --- |
| 500 | Wager-free 2,500 ARS bonus |
| 800 | VIP 100% reload up to 25,000 ARS (10x wagering) |
| 1,200 | 5,000 ARS pure cash, wager-free, instant withdrawal |
...
| Referred player STD | 2,000 ARS cash (wager-free) + 100 CC | Nothing extra (already boosted) |
| Referred player reaches 5 deposits | 5,000 ARS cash (wager-free) + Lucky Wheel spin | Nothing extra |
...
| Channel | SMS vs App Push | Open / click / deposit rate |
...
| App Push channel setup | Requires platform configuration and app update | Begin week 1, allow 3 to 4 weeks for rollout |
...
| Pre-VIP cohort smaller than expected | Medium | Low | Lower the 150,000 ARS threshold after 4 weeks if needed |
