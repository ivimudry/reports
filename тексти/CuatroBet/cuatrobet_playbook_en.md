...
Average deposit: roughly 8,000 ARS (6 USD)
Deposit frequency: 2.5 per user
Bonus cost: 10.5% of GGR in April, 9.5% in March
KYC soft threshold: 103,000 ARS (75 USD) before document verification required
...
Channel: SMS
Copy (ES): “CuatroBet: Tus giros vencen pronto. Además, te regalamos 4,600 ARS extra si depositás en las próximas 6 horas: [link]”
Offer: 4,600 ARS no-deposit bonus on any deposit action within 6 hours, 15x wagering
Exit: continues to T+24h decision
...
Offer: 75% match up to 13,500 ARS plus 20 FS on Joker’s Jewels, wagering 25x, expires in 48 hours
...
Channel: SMS
Copy (ES): “CuatroBet: Un regalo de despedida. 2,300 ARS free bet en Aviator, sin depósito. Válido 24h: [link]”
Offer: 2,300 ARS no-deposit free bet on Aviator, wagering 1x
...
T+48 h SMS: 2,300 ARS free bet on Aviator (same as Slots path)

## Cost model

Expected cost per player entering the Day 1 Layer:
Average deposit is 8,000 ARS, so the layer costs roughly 22% of the first deposit. This is fully funded from the existing bonus budget by reducing welcome bonus wagering (which lifts the bonus cost metric anyway) and stopping the NC Feed blast over-sending.
...
Identify players who have deposited 685,000 ARS cumulatively (roughly 500 USD) and coach them toward the VIP I threshold (roughly 1,370,000 ARS or 1,000 USD cumulative) within 30 days. The current VIP base is 15 players. A functioning Pre-VIP layer grows it to 30 to 45 in the first quarter by capturing players who are already on the path but are not being actively managed.

## Entry trigger

Cumulative lifetime deposits reach 685,000 ARS AND the player has been active in the last 14 days.
...
Action: enable 15% weekly cashback for 30 days (wager-free, applied every Monday on the previous week’s net losses, capped at 137,000 ARS)
...
Offer: 60% match up to 45,500 ARS plus 30 FS on a premium PP title, wagering 20x, validity 72 hours

### Day 10: Soft coaching push

Channel: Web Push plus SMS
Copy (ES): “Estás a unos 228,000 ARS de VIP I. Tu manager personal te está esperando.”
...
Offer: 100% match up to 91,000 ARS plus 50 FS plus extended cashback, wagering 15x, validity 72 hours
...
The 685,000 ARS entry threshold is calibrated against the brand’s own tier economics (Premium unlock at 69,000 ARS, Maestro at 160,000 ARS, VIP I starts around 1,370,000 ARS cumulative). Review quarterly.
...
Move KYC completion from 20% to 35 to 40% by converting verification from a compliance chore into a rewarded journey. The current state: half of verifiers complete immediately, half only when they try to withdraw, and most never complete at all. Verification is gated on the 103,000 ARS (75 USD) cumulative deposit threshold for documents, while email and phone verification are technically optional but should be driven earlier.

## Three phases

Phase 1: Email verification (day 0, triggered by registration)
Phase 2: Phone verification (day 0, immediately after email)
Phase 3: Document verification (triggered when cumulative deposits reach 69,000 ARS)
...
Content (ES): “Verificá tu email y recibí 2,300 ARS de regalo al instante”
Offer: 2,300 ARS bonus on email verification, no wagering on the bonus, can be used directly

### T+15 min decision: email verified?

Yes: credit 2,300 ARS, proceed to Phase 2
No: send T+15 min reminder SMS

### T+15 min: SMS reminder (if email not verified)

Channel: SMS
Copy (ES): “CuatroBet: Verificá tu email y recibí 2,300 ARS al instante: [link]”
...
Content (ES): “Verificá tu teléfono y recibí 2,300 ARS más. Total: 4,600 ARS al instante”
Offer: 2,300 ARS bonus on phone verification, no wagering
...
Cumulative deposits reach 69,000 ARS (roughly 50 USD) AND not yet document-verified.
Rationale: do not wait for the 103,000 ARS hard threshold. Start the document nudge 30% earlier so there is runway to complete before the withdrawal block kicks in.

### Day 1 at 69,000 ARS threshold

Channel: in-app banner plus Email
Content (ES): “Completá tu verificación ahora y desbloqueá retiros más rápidos plus un bono de 4,600 ARS”
Offer: 4,600 ARS bonus on document verification, no wagering
...
Offer: 4,600 ARS bonus still valid
...
### On cumulative deposits reaching 103,000 ARS (the hard threshold)

Channel: in-session popup plus Email plus SMS
Content (ES): “Verificación obligatoria para retiros. Completá ahora y recibí 9,000 ARS de bono final”
Offer: 9,000 ARS bonus (doubled from the Day 1 offer) as final reward for completing

### On verification acceptance

Credit the 9,000 ARS bonus
...
Action: show preset amount buttons: 2,300/4,600/32,000 ARS
...
D1 Welcome is the hook. Strongest headline bonus (120% standard, 150% for deposits above 69,000 ARS), 25x wagering, branded to the vertical.
...
D9 and D10 are the Pre-VIP gate. High match with low wagering, Lucky Wheel entries, and at D10 automatic enrollment in the Pre-VIP Lifecycle if cumulative deposits reach 685,000 ARS.

## Slots ladder (the main audience, 99% of players)

Free spins are rotated across the actual top-played slots, not Sweet Bonanza.
Safeguards for Slots: wagering contribution slots 100% / live 10% / table 5%, max bet during wagering 7,000 ARS per spin, max bonus balance 137,000 ARS at any time, one claim per deposit.
...
Segment: ad-hoc triggers set by the CRM manager (e.g., player mentioned a specific game in support, player 23,000 ARS from a tier threshold).
...
Mechanic: players earn loot box tokens through gameplay. 1 token per 23,000 ARS wagered on slots, 1 token per 45,500 ARS wagered on live. Opened manually from the dashboard.
...
Rewards: single sticker 25 CC, row of 5 is 900 ARS + 10 FS, all 30 is 45,500 ARS + premium Lucky Wheel + VIP I preview.
...
Mechanic: tiered wheel spins earned by wagering. Silver (1 per 9,000 ARS wagered), Gold (1 per 45,500 ARS), Platinum (1 per 228,000 ARS).
...
Mechanic: player opts in and commits to a fixed amount (7,000/13,500/23,000/208,000 ARS), deposits that exact amount 4 times in 7 days. Resets if a deposit does not match.
...
Active × 7 days Comm 1 specifies a base offer of “30% match up to 9,000 ARS + 20 FS on Jackpot Joker, 15x wagering, 48h validity”. Applied by tier at send time:
Micro player: 50 CC gift only, no match bonus. Reactivation cost near zero for a player unlikely to return.
Low player: 30% match up to 9,000 ARS + 20 FS, 15x, 48h. Base offer as written in the cell.
Mid player: 45% match up to 13,500 ARS + 30 FS, 15x, 48h.
High player: 60% match up to 18,500 ARS + 40 FS, 15x, 48h, sent from the CRM owner’s named email rather than the brand email.
Pre-VIP and above: 75% match up to 23,000 ARS + 50 FS + 100 CC, 12x, 72h, delivered by the CRM owner via WhatsApp with a personal message.
...
Inconsistent Free Bet pricing: 36,500 ARS free bet at 350 CC, 13,500 ARS free bet at 150 CC. Different CC-to-ARS ratios for similar products.
...
KYC required for referrer to receive rewards above 4,600 ARS cash
...
Launch bonus: first 100 successful referrals (STD) get an extra 4,600 ARS cash on top of standard reward
Leaderboard: top 10 referrers per month get an additional 45,500 ARS cash prize
...
Economics - Average deposit: 8,000 ARS (~6 USD) - Deposit frequency: 2.5 per user - Bonus cost: 10.5% of GGR - ADPU matures ~10x from month 0 ($15) to month 5 ($150)
Argentina context - Working rate: ~1,400 ARS per USD - KYC threshold: 103,000 ARS (75 USD) - Payment methods: Mercado Pago, Naranja Betterbro, bank transfer - Product mix: 99.9% casino
...
| 4,600 ARS urgency bonus (T+6h Comm B) | 30% reach rate | roughly 100 |
| 75% reload email (T+24h) | 20% claim | roughly 150 |
| 2,300 ARS Aviator free bet (T+48h) | 10% claim | roughly 25 |
| Average cost per FTD player |  | roughly 1,800 ARS |
...
| 5 | Email | 60% match up to 45,500 ARS + 30 FS (20x) | First coaching reload |
| 10 | Push + SMS | Soft coaching message, no offer | Awareness |
| 15 | Email + SMS | 100% match up to 91,000 ARS + 50 FS (15x) | Strong second chance |
...
| --- | --- | --- | --- |
| Phase 1 email | 2,300 ARS | roughly 60% | 300 |
| Phase 2 phone | 2,300 ARS | roughly 50% | 250 |
| Phase 3 docs (at 15k) | 4,600 ARS | roughly 20% | 200 |
| Phase 3 docs (at 22.5k) | 9,000 ARS | roughly 15% | 300 |
| Total average |  |  | roughly 4,800 ARS per player |
...
| 100 CC recovery reward | roughly 200 ARS | 20% of failures |
| Average cost per failure | roughly 50 ARS |  |


<!-- TABLE 5 -->
| Deposit | Match | Max cap | Free spins | Wagering | Validity | Extra |
| --- | --- | --- | --- | --- | --- | --- |
| D1 Welcome | 120% | 45,500 ARS | 50 FS on Gates of Olympus | 25x | 7 days | Max bet 7,000 ARS |
| D2 | 75% | 23,000 ARS | 30 FS on Joker’s Jewels | 20x | 48 h |  |
| D3 | 60% | 23,000 ARS | 30 FS on Jackpot Joker | 20x | 48 h |  |
| D4 | 50% | 27,500 ARS | 40 FS on 4 Supercharged Clovers | 18x | 48 h |  |
| D5 | 50% | 34,500 ARS | 50 FS rotating PP top | 18x | 48 h | 50 CC gift |
| D6 | 50% | 36,500 ARS | 60 FS | 15x | 48 h | Weekly Lucky Wheel entry |
| D7 | 60% | 45,500 ARS | 70 FS | 15x | 48 h | 100 CC gift |
| D8 | 60% | 45,500 ARS | 80 FS | 15x | 72 h | 200 CC gift |
| D9 | 70% | 69,000 ARS | 90 FS | 15x | 72 h | Lucky Wheel premium |
| D10 | 100% | 91,000 ARS | 100 FS | 12x | 72 h | 500 CC + Pre-VIP gate |


<!-- TABLE 6 -->
| Deposit | Match | Max cap | Bonus Cash | Wagering | Validity | Extra |
| --- | --- | --- | --- | --- | --- | --- |
| D1 Welcome | 120% | 45,500 ARS | 23,000 ARS | 30x | 7 days | Bet cap 5,000/hand |
| D2 | 75% | 32,000 ARS | 13,500 ARS | 25x | 48 h |  |
| D3 | 60% | 27,500 ARS | 13,500 ARS | 25x | 48 h |  |
| D4 | 50% | 34,500 ARS | 18,500 ARS | 20x | 48 h |  |
| D5 | 50% | 36,500 ARS | 23,000 ARS | 20x | 48 h | 100 CC |
| D6 | 50% | 45,500 ARS | 23,000 ARS | 20x | 48 h |  |
| D7 | 60% | 55,000 ARS | 27,500 ARS | 18x | 48 h | 200 CC |
| D8 | 60% | 69,000 ARS | 36,500 ARS | 18x | 72 h |  |
| D9 | 75% | 91,000 ARS | 45,500 ARS | 15x | 72 h | Lucky Wheel |
| D10 | 100% | 114,000 ARS | 69,000 ARS | 12x | 72 h | 500 CC + Pre-VIP gate |


<!-- TABLE 7 -->
| Deposit | Match | Max cap | Free Bet | Wagering | Validity | Extra |
| --- | --- | --- | --- | --- | --- | --- |
| D1 Welcome | 120% | 36,500 ARS | 13,500 ARS | 5x | 7 days | Min odds 1.80 |
| D2 | 75% | 23,000 ARS | 9,000 ARS | 5x | 48 h |  |
| D3 | 60% | 18,500 ARS | 9,000 ARS | 5x | 48 h |  |
| D4 | 50% | 23,000 ARS | 11,500 ARS | 5x | 48 h |  |
| D5 | 50% | 27,500 ARS | 13,500 ARS | 5x | 48 h | 50 CC |
| D6 | 50% | 32,000 ARS | 16,000 ARS | 5x | 48 h |  |
| D7 | 60% | 36,500 ARS | 18,500 ARS | 5x | 48 h | 100 CC |
| D8 | 60% | 45,500 ARS | 23,000 ARS | 5x | 72 h |  |
| D9 | 70% | 55,000 ARS | 27,500 ARS | 5x | 72 h | Lucky Wheel |
| D10 | 100% | 69,000 ARS | 36,500 ARS | 5x | 72 h | 500 CC + Pre-VIP gate |
...
| Comm 2 | T+30 min | SMS | ES 160 chars: “CuatroBet: Probá de nuevo: [link]. Sumamos 900 ARS de regalo por la molestia”. 900 ARS no-deposit goodwill credit, no wagering. |
...
| Comm 2 | T+1 h | Email (personal, “María, equipo CuatroBet”) | Subject ES: “Podemos ayudarte a depositar”. Offer callback or WhatsApp support, 3 alternate methods, 2,300 ARS goodwill credit. |
| Comm 3 | T+6 h | SMS | ES: “Responde RETRY y te llamamos, o probá acá: [link]”. 2,300 ARS credit still valid. |
...
| Comm 2 | T+2 h | Web Push | ES: “Tu bono sigue disponible. Mercado Pago acepta desde 2,300 ARS” |
...
| Comm 3 | T+24 h | Web Push | ES: “Tu bono 120% + 50 FS te espera. Depositá desde 2,300 ARS” |
...
| Comm 2 | Day of | Email + Web Push | Subject ES: “Feliz aniversario! Tu regalo te espera”. 100% reload up to 45,500 ARS + 100 FS on favorite game, 15x wagering, 7 days. |
...
| Comm 2 | Day of | Email + Web Push + SMS | Subject ES: “Feliz cumpleaños!”. 23,000 ARS wager-free cash + 50 FS on Gates of Olympus. |
...
| Comm 2 | Day 3 | Web Push | 50% match up to 23,000 ARS + 30 FS on themed slots, 20x wagering. |
...
| --- | --- | --- |
| Common | 60% | 450 ARS cash or 20 CC or 5 FS |
| Uncommon | 25% | 2,300 ARS cash or 50 CC or 15 FS |
| Rare | 10% | 7,000 ARS cash or 150 CC or 30 FS premium |
| Epic | 4% | 23,000 ARS cash or 500 CC or Lucky Wheel spin |
| Legendary | 1% | 69,000 ARS cash or VIP I preview |
...
| --- | --- |
| 4 × 4,600 ARS | 2,300 ARS cashback + 20 FS |
| 4 × 11,500 ARS | 7,000 ARS cashback + 40 FS + 100 CC |
| 4 × 23,000 ARS | 18,500 ARS cashback + 80 FS + 250 CC |
| 4 × 45,500 ARS | 45,500 ARS cashback + 150 FS + 500 CC + Lucky Wheel |
...
| Day 3 consecutive | 100 CC + 50 FS + 9,000 ARS bonus cash |


<!-- TABLE 26 -->
| Committed amount × 4 | Reward |
| --- | --- |
| 4 × 7,000 ARS | 7,000 ARS cashback + 30 FS |
| 4 × 13,500 ARS | 18,500 ARS cashback + 60 FS + 150 CC |
| 4 × 23,000 ARS | 36,500 ARS cashback + 100 FS + 300 CC + Lucky Wheel |
| 4 × 45,500 ARS | 91,000 ARS cashback + 200 FS + 750 CC + Pre-VIP preview |


<!-- TABLE 27 -->
| Tier | Total turnover across 4 slots | Reward |
| --- | --- | --- |
| Light | 91,000 ARS | 2,300 ARS cashback + 20 FS |
| Medium | 228,000 ARS | 9,000 ARS cashback + 50 FS + 100 CC |
| Heavy | 685,000 ARS | 36,500 ARS cashback + 100 FS + 300 CC + Lucky Wheel |


<!-- TABLE 28 -->
| Tier | Criteria | Offer |
| --- | --- | --- |
| Low | 1 deposit in last 7 days | 40% up to 13,500 ARS + 20 FS, 15x |
| Mid | 2 to 3 deposits | 50% up to 23,000 ARS + 30 FS + 50 CC, 15x |
| High | 4+ deposits | 60% up to 36,500 ARS + 50 FS + 100 CC, 12x |
| Pre-VIP/VIP | Status | 75% up to 69,000 ARS + 75 FS + 200 CC + cashback boost, 10x |
...
| 2 | 20 CC + 5 FS |
| 3 | 30 CC + 10 FS |
| 4 | 50 CC + 20 FS + 450 ARS |
| 5 | 75 CC + 25 FS + 1,100 ARS |
| 6 | 100 CC + 40 FS + 2,300 ARS |
| 7 (weekly reset) | 200 CC + 60 FS + 7,000 ARS + Lucky Wheel |


<!-- TABLE 30 -->
| Holiday | Date | Headline offer |
| --- | --- | --- |
| New Year | Jan 1 | 150% up to 69,000 ARS + 150 FS |
...
| Comm 3 | Day 14 | Email + SMS | 40% reload up to 13,500 ARS + 100 CC + 20 FS, 15x wagering, 72 h. |
...
| --- | --- | --- | --- |
| 1 | Day 7 | SMS | ES: “Te extrañamos. 30% en tu próximo depósito + 20 FS en Jackpot Joker: [link]”. 30% match up to 9,000 ARS + 20 FS, 15x, 48 h. |
...
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 14 | Email (personal tone) | Subject: “Nota personal de CuatroBet”. 50% up to 23,000 ARS + 30 FS on favorite game, 15x, 72 h. |
...
| 4 | 18 | Email | Subject: “Tu bono 50% terminó pero tenemos algo nuevo”. Fresh 60% up to 27,500 ARS + 40 FS + 100 CC, 72 h. |


<!-- TABLE 36 -->
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 21 | Email (from CRM owner name) | Subject: “Construimos algo que te va a encantar”. Personal tone, curated game recommendation. 75% up to 45,500 ARS + 50 FS + 250 CC, 12x, 72 h. For Pre-VIP+: 100% match + cashback boost. |
...
| 4 | 30 | Email | Subject: “Último llamado”. Escalated 100% up to 69,000 ARS + 75 FS + 500 CC, 15x, 48 h. |


<!-- TABLE 37 -->
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 7 | Email | Subject: “Tus juegos favoritos te esperan”. 25% up to 7,000 ARS + 15 FS, 15x, 72 h. |
...
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 14 | Email | 35% up to 11,500 ARS + 20 FS, 15x, 72 h. |
...
| Comm | Day | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | 21 | Email | 50% up to 18,500 ARS + 25 FS + 100 CC, 15x, 72 h. |
| 2 | 25 | SMS | Reminder. |
| 3 | 28 | Web Push | Reminder. |
| 4 | 30 | Email | Final 60% up to 23,000 ARS + 30 FS, 48 h. |


<!-- TABLE 40 -->
| Comm | Timing | Channel | Content and offer |
| --- | --- | --- | --- |
| 1 | T+0 after verification | Email | Subject: “Bienvenido! Tu cuenta está totalmente verificada”. Celebrate verification, deposit guide, enhanced welcome 150% up to 55,000 ARS + 75 FS, 20x. |
...
| 80 | 4,600 ARS site credit (10x wagering) |
| 100 | 25 FS on 4 Supercharged Clovers |
| 120 | 9,000 ARS site credit (10x wagering) |
| 150 | 30% match up to 13,500 ARS on any deposit |


<!-- TABLE 46 -->
| CC | Reward |
| --- | --- |
| 200 | 50% match up to 23,000 ARS + 20 FS on top game |
| 250 | 10 Free Flights on Aviator + 100 CC bonus |
| 300 | 13,500 ARS free bet + 2,300 ARS cashback |
| 350 | 75% match up to 36,500 ARS + 30 FS |
| 400 | 100% match up to 45,500 ARS (15x wagering) |


<!-- TABLE 47 -->
| CC | Reward |
| --- | --- |
| 500 | Wager-free 11,500 ARS bonus |
| 800 | VIP 100% reload up to 114,000 ARS (10x wagering) |
| 1,200 | 23,000 ARS pure cash, wager-free, instant withdrawal |
...
| Referred player STD | 9,000 ARS cash (wager-free) + 100 CC | Nothing extra (already boosted) |
| Referred player reaches 5 deposits | 23,000 ARS cash (wager-free) + Lucky Wheel spin | Nothing extra |
...
| Pre-VIP cohort smaller than expected | Medium | Low | Lower the 685,000 ARS threshold after 4 weeks if needed |
